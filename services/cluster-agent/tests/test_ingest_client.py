...
@pytest.mark.asyncio
async def test_verify_raises_auth_error_on_401() -> None:
...
@pytest.mark.asyncio
async def test_verify_returns_identity_on_success() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
...
@pytest.mark.asyncio
async def test_heartbeat_raises_on_other_http_errors() -> None:
    def handler(request: httpx.Request) -> httpx.Response:
